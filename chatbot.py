...
condense_template = (
    ...
    "the full intent. "
    "CRITICAL: If the follow-up question is about a completely new topic or is NOT related to the chat history, "
    "do NOT try to connect them. Just return the follow-up question exactly as it is.\n"
...
template = (
    ...
    "that correspond to the source numbers given in the context. If citing multiple sources, format them separately as [1][2] and NEVER as [1, 2] or [1,2].\n"
